...
const ThirdCategoryExamination = () => {
  const steps = [
  ...
  return (
    <div className="min-h-screen py-8 px-4 bg-gradient-to-br from-green-100 via-teal-100 to-blue-100" style={{ background: "linear-gradient(145deg, #052658, #4dffb596)" }}>
      
      {/* Header */}
      <div className="text-center mb-8">
        <div className="inline-block bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl p-6 shadow-xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-3">
            🏆 Scholarship Cup 🏆
          </h1>
          <p className="text-white/90 text-lg">Third Category - Public</p>
      ...
      {/* Category Badge */}
      <div className="text-center mb-6">
        <span className="inline-block px-6 py-2 bg-gradient-to-r from-green-500 to-teal-500 rounded-full text-white font-semibold shadow-lg">
          🎯 Third Category - Public
        </span>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          {/* Examination Info */}
          <div className="p-6 bg-gradient-to-r from-green-50 to-teal-50" style={{ background: "linear-gradient(176deg, rgb(228 192 249), rgb(79 69 239 / 59%))" }}>
            <div className="text-center mb-6">
              <div className="text-5xl mb-3">📋</div>
              <h2 className="text-2xl font-bold text-blue-800">Third Category Examination</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="bg-yellow-100 rounded-xl p-4 text-center border border-yellow-300">
                ...
                <p className="text-gray-800 text-3xl font-bold">₹555/-</p>
                ...
                {steps.map((step, index) => (
                  <div key={index} className="flex-1 text-center">
                    ...
                    {index < steps.length - 1 && (
                      <div className="absolute top-8 left-[calc(50%+40px)] w-[calc(100%-80px)] h-0.5 bg-gradient-to-r from-green-400 to-transparent -z-10"></div>
                    )}
                  </div>
                ))}
              </div>
...
export default ThirdCategoryExamination;