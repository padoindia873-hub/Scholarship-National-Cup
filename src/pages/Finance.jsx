...
const Finance = () => {
  const members = [
    { name: "Bholanath De", designation: "Secretary", photo: m1 },
    { name: "Bipul Mondal", designation: "Vice Secretary", photo: m2 },
    { name: "Pradip Kumar Goswami", designation: "President", photo: m5 },
    { name: "Afsasur Rahaman Sardar", designation: "Treasurer", photo: m3 },
    { name: "Anirban Saha", designation: "Assistant Treasurer", photo: m4 },
  ];
    ...
    >
      ...
      <div className="text-center mb-12 animate-slideDown">
        ...
        <p className="text-white/80 text-base sm:text-lg max-w-2xl mx-auto">
          Meet our dedicated finance team managing the competition's funds and budgets
        </p>
      ...
      <Swiper
        ...
        loop={true}  // ← Added for infinite loop
        autoplay={{
          delay: 2000,
